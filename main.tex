...
\mbox{Dieser Text ist auch geschützt und wird nicht getrennt.}
...
\noindent   Einrückung verhindern

\begin{center}
\end{center}
%flushright... rechtbündig

{\centering Dies ist ein zentrierter Satz.\par}
{\raggedleft Das hier rechtbündig. \par}
...
\begin{table}[h] %h für Anordnung an Textstelle
\centering %Mittig
\begin{tabular}{l|l|l} %Querstriche für Zeichnen der Linien; l feste breite, X variable Breite
Hi & Hi & Hi \\ \hline %hline ist horizontale Linie
Hi & Hi & Hi \\ \hline
Hi & Hi & Hi \\ \hline
Hi & Hi & Hi \\ \hline
Hi & Hi & Hi \\ \hline
\end{tabular}
\caption{Hi} %Caption wie bei Bildern
\end{table}

%Ein bisschen weiterführender: \begin{tblr}{width=\textwidth, colspec={X|X|X}, hlines, vlines} mit \usepackage{tabulararray}
